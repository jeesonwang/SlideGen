...
class PresentationGenerator:
    ...
    async def generate_presentation(
        ...
        presentation = await self.converter.generate(template_prs, markdown_doc, theme=theme, template_name=request.template)
    ...
    async def generate_from_markdown(
        ...
        logger.info("Converting Markdown to PowerPoint...")
        presentation = await self.converter.generate(
            template_prs,
            markdown_doc,
            theme=theme,
